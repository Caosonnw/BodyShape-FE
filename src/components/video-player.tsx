...
const videoPlayerVariants = cva('relative w-full bg-black rounded-[var(--card-radius)] overflow-hidden group', {
  variants: {
    size: {
      sm: 'max-w-md',
      default: 'max-w-2xl',
    ...
    return (
      ...
      >
        ...
        <video
          ...
          src={src}
          poster={poster}
          className='w-full h-full sobject-cover !object-contain'
          onClick={togglePlay}
          {...props}
        />
        {showControls && (
          <>
            ...
            >
              ...
              >
                {isLoading ? (
                  <div className='w-6 h-6 border-4 border-white/90 border-t-transparent rounded-full animate-spin' />
                ) : isPlaying ? (
            ...
            >
              <div className='p-4 space-y-3 pointer-events-auto'>
                ...
                <div className='flex items-center gap-2 text-white text-sm'>
                  <span className='min-w-0 text-xs font-mono'>{formatTime(currentTime)}</span>
                  ...
                  <span className='min-w-0 text-xs font-mono'>{formatTime(duration)}</span>
                </div>
