...
export default function NotFound() {
  ...
  return (
    <section className='bg-white font-serif min-h-screen flex items-center justify-center w-full'>
          ...
          <div className='w-full sm:w-10/12 md:w-8/12 text-center'>
            ...
            <div className='mt-[-50px]'>
              ...
              <Button
                variant='default'
                onClick={() => router.push('/')}
                className='my-5 bg-[#f7244f] hover:bg-[#f50637] hover:cursor-pointer transition-all duration-500 ease-in-out'
              >
                Go to Home
              </Button>
            </div>
