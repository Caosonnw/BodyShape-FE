    ...
    <Dialog onOpenChange={setOpen} open={open}>
      <DialogTrigger asChild>
        <Button size='sm' className='h-10 gap-1 text-[13px] hover:cursor-pointer'>
          ...
          <span className='sr-only sm:not-sr-only sm:whitespace-nowrap'>Add Equipment</span>
        </Button>
      </DialogTrigger>
      <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto' onEscapeKeyDown={() => setOpen(false)}>
        ...
        <DialogFooter>
          <Button type='submit' form='add-equipment-form' className='hover:cursor-pointer'>
            Add Equipment
          </Button>
        </DialogFooter>
      </DialogContent>
