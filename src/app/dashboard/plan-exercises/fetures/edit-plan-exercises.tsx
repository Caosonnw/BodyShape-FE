...
export default function EditExercise({
  ...
  const { data } = useGetEquipmentById({ equipmentId: exerciseId as number, enabled: Boolean(exerciseId) })
  ...
  const onSubmit = async (values: UpdateEquipmentType) => {
    ...
    try {
      let body: UpdateEquipmentType & { equipmentId: number } = { equipmentId: exerciseId as number, ...values }
